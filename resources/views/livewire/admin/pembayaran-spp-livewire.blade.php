                ...
                <div class="row">                      
                    ...
                    <div class="{{ $block == true ? 'col-3' : 'col-4' }}">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.lazy="tgl_bayar" class="form-control round @error('tgl_bayar') is-invalid @enderror" placeholder="000009" id="tgl_bayar">
                            @error('tgl_bayar')                         
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-lg-3 {{ $block == true ? '' : 'd-none' }}">
                        <div class="form-group">
                            ...
                            <input disabled type="text" wire:model="nominal" class="form-control round @error('nominal') is-invalid @enderror" placeholder="000009">
                            @error('nominal') 
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span> 
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.lazy="jumlah_bayar" class="form-control round @error('jumlah_bayar') is-invalid @enderror" placeholder="000009">
                            @error('jumlah_bayar')                         
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span> 
            ...
            <table class="table table-responsive-sm table-hover-animation">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $pembayaran->siswa->spp->nominal }}</td>
                        <td>
